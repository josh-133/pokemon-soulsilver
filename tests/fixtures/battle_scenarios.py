...
def player_with_charizard(charizard):
    ...
    player = Player(name="Ash", is_ai=False, team=[charizard])
...
def player_with_blastoise(blastoise):
    ...
    player = Player(name="Gary", is_ai=True, team=[blastoise])
    player.active_index = 0
    return player
...
def player_with_full_team(charizard, blastoise, venusaur):
    ...
    player = Player(name="Trainer", is_ai=False, team=[charizard, blastoise, venusaur])
    player.active_index = 0
    return player
...
def type_advantage_battle(charizard, blastoise):
    ...
    player1 = Player(name="Player1", is_ai=False, team=[charizard])
    player1.active_index = 0
    
    player2 = Player(name="Player2", is_ai=True, team=[blastoise])
...
def status_effect_battle(charizard, venusaur):
    ...
    player2 = Player(name="Player2", is_ai=True, team=[venusaur])
    player2.active_index = 0
